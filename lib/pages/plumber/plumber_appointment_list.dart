...
import 'package:photo_view/photo_view.dart';import 'package:plumber_project/services/api_service.dart';
...
class PlumberAppointmentList extends StatefulWidget {
  @override
  _PlumberAppointmentListState createState() => _PlumberAppointmentListState();
}

class _PlumberAppointmentListState extends State<PlumberAppointmentList> {
  ...
  Future<void> _loadAppointments() async {
    try {
      ...
      print('Loading Plumber appointments...');
  ...
  Future<void> _fetchProblemImageFromFirebase(String providerId, String appointmentId) async {
    ...
    try {
      final querySnapshot = await FirebaseFirestore.instance
          .collection('plumber_appointment')

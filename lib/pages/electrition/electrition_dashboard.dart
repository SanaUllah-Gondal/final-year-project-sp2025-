...
class ElectricianDashboard extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: _electricianController.manuallyCheckRequests,
  ...
  Widget _buildFaceVerificationIndicator() {
    return GestureDetector(
      onTap: () {
        if (!_electricianController.isFaceVerified.value) {
          Get.defaultDialog(
            ...
            onConfirm: () {
              Get.back();
              _electricianController.verifyUserIdentity();
            },
          );
        }
      },
      child: Container(
        ...
        decoration: BoxDecoration(
          color: _electricianController.isFaceVerified.value
              ? verifiedColor
              : unverifiedColor,
        ...
        child: Row(
          ...
          children: [
            Icon(
              _electricianController.isFaceVerified.value
                  ? Icons.verified_user

...
class ElectricianProfileController extends GetxController {
  // Form controllers
  ...
  Future<void> initializeData() async {
    try {
      ...
      roleController.text = prefs.getString('role') ?? 'electrician';
  ...
  Future<void> checkExistingProfile() async {
    try {
      ...
      final response = await _authenticatedRequest(
        '$baseUrl/api/electrician/profile/check',
  ...
  Future<void> loadExistingProfile(String profileId) async {
    try {
      ...
      final response = await _authenticatedRequest(
        '$baseUrl/api/electrician/profile/$profileId',
      ).timeout(const Duration(seconds: 10));
  ...
  Future<void> submitProfile() async {
    try {
      ...
      final url = isUpdate ? '$baseUrl/api/electrician/profile' : '$baseUrl/api/electrician/profile';
  ...
  Future<void> saveFaceDataToFirebase() async {
    try {
      ...
      final faceData = {
        ...
        'role': 'electrician', // Add role to distinguish
      };
  ...
  // UPDATED saveProfileToCloud with face data

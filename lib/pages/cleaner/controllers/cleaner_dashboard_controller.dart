...
class CleanerDashboardController extends GetxController {
  ...
  Future<void> getLiveLocation() async {
    try {
      ...
      // Format address name (more descriptive)
  ...
  Future<void> loadAvailableJobs() async {
    try {
      isLoading.value = true;
      final response = await _apiService.getAvailableProviders('cleaner');
